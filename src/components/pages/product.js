...
import Graph from '../structural/graph';

export default function Product() {
    const[reading, setReading] = useState(0)
   
    const tick=() => {
        if(reading != new Date().getSeconds() ){
        setReading(reading+1,1000)}

    }
    useEffect(() => {
        
        // console.log('Time in seconds' + new Date().getSeconds());
        // tick()
        return () => {
        ...
        <div className="productPage">
            ...
            <div className="featuresGrid">
                ...
                <g id="cogs2">
                    ...
                    <circle className="cls-2cog" cx="99.66" cy="86.86" r="7.78"/>
                </g>
                </svg>
                <h1>AI</h1>
                <Graph></Graph>            
                ...
                <SplitFlapDisplay
                    ...
                    textColor = "#1B1B1B"
                />
                <button onClick={()=>tick()}>Press to increase</button>
